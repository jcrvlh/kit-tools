...
DESIGN = 240.0
HEAD = (96.0, 22.0, 48.0, 48.0, 24.0)           # x, y, w, h, r  (círculo)
PARTS = (
    (104.0, 82.0, 32.0, 86.0, 15.0),            # tronco
    (70.0,  40.0, 20.0, 66.0, 10.0),            # braço esquerdo
    (150.0, 40.0, 20.0, 66.0, 10.0),            # braço direito
)
FIG = (0x2C, 0x3C, 0xC4, 255)                   # KIT_COLOR_BLUE
...
def _sample(px, py):
    if _round_rect_sdf(px, py, *HEAD) <= 0:
        return FIG
    for part in PARTS:
