...
STROKE = 3.0
TRI = ((120.0, 46.0), (87.0, 100.0), (153.0, 100.0))
CIRCLE = (120.0, 132.0, 26.0)                    # cx, cy, r
SQUARE = (95.0, 162.0, 50.0, 50.0, 7.0)          # x, y, w, h, r

CARD_FILL   = (0x0A, 0x0A, 0x0B, 255)
CARD_BORDER = (0x3A, 0x3A, 0x3E, 255)
C_TRI       = (0xE9, 0xB2, 0x3C, 255)
C_CIRCLE    = (0x2C, 0x3C, 0xC4, 255)
C_SQUARE    = (0xC6, 0x47, 0x2F, 255)
...
def _sample(px, py):
    ...
    if _in_triangle(px, py, TRI):
        col = C_TRI
    elif math.hypot(px - cx, py - cy) <= cr:
        col = C_CIRCLE
    elif _round_rect_sdf(px, py, *SQUARE) <= 0:
        col = C_SQUARE
    return col
