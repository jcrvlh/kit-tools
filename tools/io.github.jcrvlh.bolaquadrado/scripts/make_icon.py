...
Quadrado + círculo, os dois azuis (cor base da Tool) — a mesma dupla que
abre o jogo, diferenciada só pela forma, nunca pela cor.
...
SQUARE_COLOR = (0x2C, 0x3C, 0xC4, 255)   # KIT_COLOR_BLUE
CIRCLE_COLOR = (0x2C, 0x3C, 0xC4, 255)   # KIT_COLOR_BLUE

SQUARE = (37.0, 82.0, 76.0, 76.0, 0.0)   # x, y, w, h, r — canto vivo, é "o quadrado"
CIRCLE_CENTER = (168.0, 120.0)
CIRCLE_R = 40.0
...
def _sample(px, py):
    ...
    if _round_rect_sdf(px, py, *SQUARE) <= 0:
        return SQUARE_COLOR

    dx = px - CIRCLE_CENTER[0]
    dy = py - CIRCLE_CENTER[1]
